...
class PerrsonalDefault extends React.Component<any, any> {
  ...
  sonRef      = null;
  changeOtherDialogTimer      = null;
  openDmpDialogTimer      = null;
  isGroupFlag          = false;
  ...
  _getWebPageInfo = () => {
    return LoginUtils.getStatus()
      ...
      .then((data     ) => {
        ...
        // wap页头是否配置购物车
        const wapHasCartIcon = this.headStyle?.iconTexts?.some((item     ) => item?.iconAttribute === 'cart');
