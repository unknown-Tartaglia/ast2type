...
class UserInfo extends Component<any, any> {
  ...
  // 我的会员
  renderMyMember = (_styles     , theme     , useNewLayout         ) => {
  ...
  private renderAddress(_styles     , isMember     , mergeStyle     , theme     )                  {
    return (
      <TouchableOpacity
        activeOpacity={1}
        style={[
  ...
  private getNormalCol(theme     , mergeStyle     )         {
