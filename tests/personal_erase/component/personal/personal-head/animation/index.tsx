...
export default class AnimationHeader extends Component<AnimationHeaderProps, any> {
  renderHeaderTitle = (_styles     , titleAnimatedValue     ) => {
  ...
  renderText = (showText         , _styles     , item     ) => {
    return showText ? (
  ...
  renderIcon = (showIcon         , avatarIcon        , _styles     , item     ) => {
    return showIcon ? (
      <FastImageView
        imgUri={avatarIcon}
        imgStyle={[
  ...
  renderUnloginHeader = (_styles     , mergeStyle     , unLoginText        , defaultAvatar        , unLoginDefaultAvatar        ) => {
