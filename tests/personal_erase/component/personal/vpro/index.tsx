...
class VMember extends Component<vMemberType, any> {
  ...
  private showMoreMemberInfo(_styles     , params     ) {
    const {
      showMemberIcon,
      memberUrl,
      showMemberText,
